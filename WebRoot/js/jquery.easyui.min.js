...
},message:"请输入正确的邮箱地址"},url:{validator:function(_568){
...
},message:"请输入正确的url"},length:{validator:function(_569,_56a){
var len=$.trim(_569).length;
return len>=_56a[0]&&len<=_56a[1];
},message:"该值必须在{0} 至 {1}之间"},remote:{validator:function(_56b,_56c){
var data={};
data[_56c[1]]=_56b;
