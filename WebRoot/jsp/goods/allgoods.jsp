...
<script>
  ...
  <body>
   ...
   <div class="pageBean">
    <a href="<c:url value='/findAllGoods.action?currentPage=1'/>">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <c:if test="${pageBean.currentPage-1 >0 }">
    	<a href="<c:url value='/findAllGoods.action?currentPage=${pageBean.currentPage-1 }'/>">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </c:if>
    	第${pageBean.currentPage }页/共${pageBean.totalPage }页&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <c:if test="${pageBean.currentPage +1 <= pageBean.totalPage }">
    	<a href="<c:url value='/findAllGoods.action?currentPage=${pageBean.currentPage+1 }'/>">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </c:if>
    <a href="<c:url value='/findAllGoods.action?currentPage=${pageBean.totalPage }'/>">尾页</a>
    </div>
  </body>
</html>
